# Django settings for sorokin_test2 project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': '../../sorokin_test2.sqlite',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'zt-6#8dti_18!-hs605yxwe5h&amp;s^x&amp;6!p)3ibdjtcf*e5yr4%('
